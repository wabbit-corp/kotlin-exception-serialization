...
// managed-integrity-v1: LqAg755ap42
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-exception-serialization", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-exception-serialization")
        description.set("kotlin-exception-serialization")
        url.set("https://github.com/wabbit-corp/kotlin-exception-serialization")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-exception-serialization")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-exception-serialization.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-exception-serialization.git")
        }
    }
}
