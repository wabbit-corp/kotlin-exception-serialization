...
publishing {
    publications {
        create<MavenPublication>("maven") {
            groupId = "one.wabbit"
            artifactId = "kotlin-exception-serialization"
            version = "1.1.0"
...
kover {
    ...
    //             // title.set("kotlin-exception-serialization Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    moduleName.set("kotlin-exception-serialization")
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-exception-serialization/tree/master/src/main/kotlin")
